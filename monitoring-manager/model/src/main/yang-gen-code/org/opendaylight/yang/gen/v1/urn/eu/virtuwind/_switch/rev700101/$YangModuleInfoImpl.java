package org.opendaylight.yang.gen.v1.urn.eu.virtuwind._switch.rev700101 ;
...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "switch-config";
    private final String namespace = "urn:eu:virtuwind:switch";
    private final String revision = "1970-01-01";
    private final String resourcePath = "/META-INF/yang/switch-config.yang";
